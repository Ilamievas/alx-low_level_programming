...
/**
 * check99 - checks that the file_to was created and/or can be written to
 * @check: checks if true of false
 * @file: file_to name
 * @fd_from: file descriptor of file_from, or -1
 * @fd_to: file descriptor of file_to, or -1
...
/**
 * check100 - checks that the file descriptors were closed properly
...
/**
 * main - opies the content of the file to another file.
